...
#SBATCH --output=/mnt/lustre/work/luxburg/shared_data/moritz_sebastian_2025/logs/sp-mse-loss-coordinate-check-init/%x_%A_%a.out  
#SBATCH --error=/mnt/lustre/work/luxburg/shared_data/moritz_sebastian_2025/logs/sp-mse-loss-coordinate-check-init/%x_%A_%a.err   
...
python pretrain-experiment.py \
    ...
    --experiment_name "sp-mse-loss-coordinate-check-init" \
    --model "pythia-14m" \
    --qk_norm \
    --width $WIDTH \
