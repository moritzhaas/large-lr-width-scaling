...
#SBATCH --output=/mnt/lustre/work/luxburg/shared_data/moritz_sebastian_2025/logs/standard-transformer-lr-sweep-layernorm-no-affine/%x_%A_%a.out  
#SBATCH --error=/mnt/lustre/work/luxburg/shared_data/moritz_sebastian_2025/logs/standard-transformer-lr-sweep-layernorm-no-affine/%x_%A_%a.err   
...
python pretrain-experiment.py \
    ...
    --experiment_name "standard-transformer-lr-sweep-layernorm-no-affine" \
    --model "pythia-14m" \
    --qk_norm \
    --layernorm_no_elementwise_affine \
    --width $WIDTH \
