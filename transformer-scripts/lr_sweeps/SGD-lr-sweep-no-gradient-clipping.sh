...
#SBATCH --output=/mnt/lustre/work/luxburg/shared_data/moritz_sebastian_2025/logs/SGD-lr-sweep-no-gradient-clipping/%x_%A_%a.out  
#SBATCH --error=/mnt/lustre/work/luxburg/shared_data/moritz_sebastian_2025/logs/SGD-lr-sweep-no-gradient-clipping/%x_%A_%a.err   
...
python pretrain-experiment.py \
    ...
    --experiment_name "SGD-lr-sweep-no-gradient-clipping" \
    --model "pythia-14m" \
    --qk_norm \
    --width $WIDTH \
